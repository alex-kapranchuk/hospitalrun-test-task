...
public class LeftBarMedication extends BaseTest {
    ...
    public String getRequestText() {return Requests.getText();}

    @Step("Verify the Completed is present")
    public String getCompletedText() {return Completed.getText();}

    @Step("Verify the NewRequest is present")
    public String getNewRequestText() {return NewRequest.getText();}

    @Step("Verify the ReturnMedication is present")
    public String getReturnMedicationText() {return ReturnMedication.getText();}

    @Step("Click New NewRequest")
    public void ClickNewRequest(){NewRequest.click();}
